...
*   **Gauthier** : Architecture logicielle, Physique & HUD.
*   **Jules** : Design visuel & Sprites.
*   **Antigravity (AI)** : Optimisations, Correction de bugs & Nouvelles fonctionnalités.
